...
#[test]
fn emit_u16() {
    test_emit_data_set(get_u16_data(), |ref mut e, d| Ok(e.emit_u16(d)));
}
...
#[test]
fn emit_i32() {
    test_emit_data_set(get_i32_data(), |ref mut e, d| Ok(e.emit_i32(d)));
}
...
#[test]
fn emit_u32() {
    test_emit_data_set(get_u32_data(), |ref mut e, d| Ok(e.emit_u32(d)));
}
